...
class Classifier():
    ...
    #примена унакрсне валидације са к партиција при обучавању класификатора
    def start(self, x_reduced, Y, classes, class_distribution):
      #  error_rate = []
        ...
        for i, r in enumerate(class_distribution[1:]):
            ...
            # позивање апстрактне методе која је за сваки тип класификатора врши иницијализацију
...
# Позивање ф-ја које рачунају мере успешности и испис резултата
